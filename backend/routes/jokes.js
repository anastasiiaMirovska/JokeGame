...
await jokesController.getJoke(req, res);
});
...
await jokesController.changeJoke(req, res)
});

router.delete('/:id', async (req, res) => {await jokesController.deleteJoke(req, res)
});

router.get('/all', async (req, res) => {
    await jokesController.getAllJokes(req, res)
});

router.get('/add', async (req, res) => {
await jokesController.addJokes(req, res);
});
